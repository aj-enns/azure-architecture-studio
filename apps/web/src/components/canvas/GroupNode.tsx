...
const kindStyle: Record<GroupKind, { border: string; bg: string; header: string }> = {
  subscription: { border: 'border-slate-400/70', bg: 'bg-slate-400/[0.04]', header: 'bg-slate-500/15 text-slate-600 dark:text-slate-300' },
  resourceGroup: { border: 'border-sky-400/70', bg: 'bg-sky-400/[0.04]', header: 'bg-sky-500/15 text-sky-700 dark:text-sky-300' },
  vnet: { border: 'border-emerald-400/70', bg: 'bg-emerald-400/[0.04]', header: 'bg-emerald-500/15 text-emerald-700 dark:text-emerald-300' },
  subnet: { border: 'border-cyan-400/70', bg: 'bg-cyan-400/[0.04]', header: 'bg-cyan-500/15 text-cyan-700 dark:text-cyan-300' },
  custom: { border: 'border-muted-foreground/50', bg: 'bg-muted/10', header: 'bg-muted text-muted-foreground' },
};
